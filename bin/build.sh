...
gcc output/str.o output/checks.o output/args.o output/node.o output/linked_list.o output/image.o output/color_changer.o output/path.o output/main.o -o c-color-changer -g -lpng
